...
var projectName = "RIMIKS.Backend";
...
var testProjects = new List<Tuple<string, string[]>>
                {
                    ...
                    new Tuple<string, string[]>("Abp.AutoMapper.Tests", new[] { "net461", "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.Castle.Log4Net.Tests", new[] { "net461", "netcoreapp2.1" }),
                    ...
                    new Tuple<string, string[]>("Abp.EntityFrameworkCore.Dapper.Tests", new[] { "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.EntityFrameworkCore.Tests", new[] { "net461", "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.MailKit.Tests", new[] { "net461", "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.MemoryDb.Tests", new[] { "net461", "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.NHibernate.Tests", new[] { "net461" }),
                    new Tuple<string, string[]>("Abp.Quartz.Tests", new[] { "net461" }),
                    new Tuple<string, string[]>("Abp.RedisCache.Tests", new[] { "net461", "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.TestBase.SampleApplication.Tests", new[] { "net461" }),
                    new Tuple<string, string[]>("Abp.Tests", new[] { "net461", "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.Web.Api.Tests", new[] { "net461" }),
                    new Tuple<string, string[]>("Abp.Web.Common.Tests", new[] { "net461", "netcoreapp2.1" }),
                    ...
                    new Tuple<string, string[]>("Abp.ZeroCore.Tests", new[] { "netcoreapp2.1" }),
                    new Tuple<string, string[]>("Abp.ZeroCore.IdentityServer4.Tests", new[] { "netcoreapp2.1" })
                };
